...
public class WordData {
    ...
    public boolean hasImageField() {
        return !ObjectUtils.isEmpty(imageFieldMap);
    }
    ...
    public boolean hasTextField() {
        return !ObjectUtils.isEmpty(textFieldMap);
    }
    ...
    public boolean hasIterator() {
        return !ObjectUtils.isEmpty(iteratorMap);
    }
    ...
    public boolean hasTable() {
        return !ObjectUtils.isEmpty(tableMap);
    }
